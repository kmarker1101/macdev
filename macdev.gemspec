...
Gem::Specification.new do |spec|
  ...
  spec.description   = 'Create Nix-like isolated development environments on macOS using Homebrew, ' \
                       'with support for pure (project-scoped) and impure (system-wide) packages'
